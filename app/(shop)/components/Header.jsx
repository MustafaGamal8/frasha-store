  ...
  return (
    <header>
      <section className="relative w-full h-[450px] bg-primary flex md:flex-row flex-col-reverse items-center  justify-around z-[-1] p-2 ">
        ...
        <h1 className="text-white md:text-3xl text-xl text-right md:mt-0 mt-10 animate__animated animate__fadeInRight">متخصصون في بيع منتجات الهاند ميد والتطريز <br />والهدايا و الملابس والاكسسورات</h1>

        <div className="w-full absolute -bottom-1 left-0 z-[-2]  animate__animated animate__fadeInUp">
      ...
      <section className="w-full flex flex-wrap items-center justify-center gap-16  p-4 ">
        {sectionData.map((item) => (
          <div key={item.id}
            className="group relative flex flex-col items-center gap-3 hover:bg-none bg-white p-4 px-8 md:px-12 rounded border-t-2 border-primary  drop-shadow-md animate__fadeIn"
          >
